...
{
	public class CursoQueriesParte1
	{
		...
		public static void ConsultaFaixaEGenero()
		{
			using (var contexto = new AluraTunesEntities())
			{
		...
		public static void RefinandoConsultas(string v, string d)
		{
		...
		public static void TestandoComBancoDeDados()
		{
			ConsultaFaixaEGenero();
		}

		public static void TestandoComWhereSemJoin()
		{
			using (var contexto = new AluraTunesEntities())
			{
		...
		public static void UsandoCount()
		{
			using (var contexto = new AluraTunesEntities())
			{
				//sintaxe de consulta
		...
		public static void UsandoMedianaComMetodoDeExtensao()
		{
			using (var contexto = new AluraTunesEntities())
			{
		...
		public static void UsandoMinMaxAvg()
		{
			using (var contexto = new AluraTunesEntities())
			{
				// várias consultas
